...
public class IMAPCommandSubscribe extends IMAPCommand {
	
	public IMAPCommandSubscribe(String comm, int minState, int maxState, HostMail host) {
	...
	public void run(IMAPWork focus, String letters, String[] args) throws IOException {
		if (args.length >= 1) {
			...
			if (m == null) {
				...
				m.subscribed = true;
				focus.writeLine(letters, "OK Mailbox subscribed.");
			}
		}else {
