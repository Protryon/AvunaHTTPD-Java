...
public final class AvunaAgentSession {
	...
	public AvunaAgentSession(VHost vhost, URL[] urls) {
		this.vhost = vhost;
		this.jlcl = new AvunaAgentClassLoader(urls.clone(), this.getClass().getClassLoader());
		PluginAvunaAgent.sessions.add(this);
	}
