 ...
 * @since JDK1.0
 */
public class ByteArrayInputStreamExtended extends InputStream {
	
	// extension start
	public void restart(byte[] buf) {
		this.buf = buf;
		this.pos = 0;
		this.mark = 0;
	...
	public ByteArrayInputStreamExtended() {
	 ...
	 * by the creator of the stream. Elements <code>buf[0]</code> through <code>buf[count-1]</code> are the
	...
	/**
	 * Creates a <code>ByteArrayInputStream</code> so that it uses <code>buf</code> as its
	 * buffer array.
	 ...
	 * buffer array. The initial value of <code>pos</code> is <code>offset</code> and the initial value
	 * of <code>count</code> is the minimum of <code>offset+length</code> and <code>buf.length</code>.
	 ...
	 * byte is returned as an <code>int</code> in the range <code>0</code> to <code>255</code>. If no byte is available
	 ...
	 * end of file. Otherwise, the number <code>k</code> of bytes read is equal to the smaller of <code>len</code> and <code>count-pos</code>.
	 * If <code>k</code> is positive, then bytes <code>buf[pos]</code> through <code>buf[pos+k-1]</code> are copied into <code>b[off]</code> through <code>b[off+k-1]</code> in the manner performed
	 ...
	 * The actual number <code>k</code> of bytes to be skipped is equal to the smaller
